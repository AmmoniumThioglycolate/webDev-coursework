...
<body>
    ...
    <?php 
        ...
        if (isset($_COOKIE['currentUser'])){
            echo "<a style='background-color:green;'class='btn btn-success btn-lg' href='./pairs.php' role='button'>Click Here To Play</a>";
        ...
        if (isset($_COOKIE['justRegistered'])){
                echo "<script>alert('You've now been registered')</script>";
            }
    ?>
    <br/>
